  ...
  <div id="app">
    ...
    <div class="main">
      ...
      >
        ...
        >Edit Unit</b-navbar-brand>
      </b-navbar>

      <div v-for="(item , index) in unit.results" :key="index" style="margin-top:25px;">
...
export default {
  ...
  methods: {
    ...mapActions(["callUnit","snAdd","snAddErr"]),
    ...
    editCC(item) {
      ...
      axios
        .put("/api/base/item-units/" + self.$route.params.id, {
          code: item.code,
          label: item.label,
          active:item.active
        })
