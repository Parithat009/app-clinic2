  ...
  <div id="app">
    ...
    <div class="main">
      ...
      >
        ...
        >Edit Differential</b-navbar-brand>
      </b-navbar>

      <div v-for="(item , index) in ex.results" :key="index" style="margin-top:25px;">
        <div v-if="item.id == $route.params.id">
          ...
          <router-link to="/differential" class="rtl">
            <v-btn small color="green" style="color:white;" v-on:click="editEX(item)">SAVE</v-btn>
          </router-link>
