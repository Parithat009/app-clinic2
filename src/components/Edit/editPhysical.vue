  ...
  <div id="app">
    ...
    <div class="main">
      ...
      >
        ...
        >Edit Physical</b-navbar-brand>
      </b-navbar>

      <div v-for="(item , index) in pe.results" :key="index" style="margin-top:25px;">
...
export default {
  ...
  data() {
    return {
      person: [
        { code: "parithat", blood: "testtest1234" },
        { code: "12", blood: "a" },
        { code: "13", blood: "b" },
        { code: "14", blood: "c" },
        { code: "15", blood: "d" }
  ...
  methods: {
    ...mapActions(["callPE", "snAdd", "snAddErr"]),

    editPE(item) {
      var self = this;

      axios
        .put("/api/base/base-pes/" + self.$route.params.id, {
          code: item.code,
          label: item.label,
          active: item.active
        })
