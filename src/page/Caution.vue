  ...
  <div id="app">
    ...
    <div class="main">
      ...
      <v-card style="width:100%; box-shadow: 5px 5px 5px #ccc;">
        <v-data-table :headers="headers" :items="caution.results" :search="search">
...
export default {
  ...
  computed: {
    ...mapState(["caution", "snColor", "snText", "snackbar"])
  },
  ...
  methods: {
    ...
    deleteConfirm() {
      ...
      axios
        .delete("/api/base/item-cautions/" + self.delete.id)
    ...
    editCode(i) {
      this.$router.push({ path: "./caution/edit/" + i.id });
    },
    add() {
