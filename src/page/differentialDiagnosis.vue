  ...
  <div id="app">
    ...
    <div class="main">
      ...
      >
        ...
        >Differential Diagnosiss List</b-navbar-brand>
        <v-spacer></v-spacer>
      ...
      <v-card style="width:100%; box-shadow: 5px 5px 5px #ccc;">
        <v-data-table :headers="headers" :items="ex.results" :search="search">
...
export default {
  ...
  methods: {
    ...
    deleteConfirm() {
      var self = this;
      axios
        .delete("/api/base/base-exes/" + self.delete.id)
    ...
    editCode(i) {
      this.$router.push({ path: "./differential/edit/" + i.id });
    },
    add() {
