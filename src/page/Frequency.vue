  ...
  <div id="app">
    ...
    <div class="main">
      ...
      <v-card style="width:100%; box-shadow: 5px 5px 5px #ccc;">
        <v-data-table :headers="headers" :items="frequency.results" :search="search">
...
export default {
  ...
  computed: {
    ...mapState(["frequency", "snColor", "snText", "snackbar"])
  },
  ...
  methods: {
    ...
    deleteConfirm() {
      ...
      axios
        .delete("/api/base/item-frequencies/" + self.delete.id)
    ...
    editCode(i) {
      this.$router.push({ path: "./frequency/edit/" + i.id });
    },
    add() {
      this.$router.push({ path: "./frequency/add" });
    },
    ...mapActions(["callFrequency", "snStop","snAdd"])
  },
  mounted() {
    this.callFrequency();
  }
